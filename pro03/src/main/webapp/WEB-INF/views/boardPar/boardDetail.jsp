    ...
    <div class="contents" id="contents">
        <section class="page" id="page1">
            <div class="page_wrap">
                    ...
                    <thead>
                        ...
                        <tr>
                            <td>
                                ...
                                <a href="${path}/boardPar/edit.do?bno=${dto.bno}" class="inbtn">수정</a>
                                </c:if>
                            </td>
                            <td>
                                <c:if test="${not empty sid && (sid eq 'admin' || dto.author eq sid)}">
                                <a href="${path}/boardPar/delete.do?bno=${dto.bno}" class="inbtn delete_btn" >삭제</a>
                               </c:if>
                            </td>
                            <td>${dto.author}</td>
                            <td>${dto.resdate}</td>
                        ...
                        <tr>
                            ...
                            <td class="item4">
                                <c:if test="${sid eq lev.author || sid eq 'admin'}">
                                    <a href="${path}/boardPar/edit.do?bno=${lev.bno}" class="inbtn">수정</a>
                                    <a href="${path}/boardPar/delete.do?bno=${lev.bno}" class="inbtn delete_btn"> 삭제 </a>
                                </c:if>
                            </td>
                        </tr>
                    </c:forEach>
                ...
                <form action="${path}/boardPar/commentInsert.do" id="login_frm" class="frm" method="post">
                    <table class="tb3">
                        <tbody>
                        <tr>
